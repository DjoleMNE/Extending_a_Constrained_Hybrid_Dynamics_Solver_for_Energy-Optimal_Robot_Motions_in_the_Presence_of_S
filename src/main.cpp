...
private:
    ...
    void iterate_over_torques(const std::vector<double> resolution, int joint, const std::vector<int> steps_set, std::vector<double> resulting_set){
        ...
        if (joint >= numb_joints) {
            ...
            //The jointAccelerations input is given if we want to have specific joint acceleration...at certan joint
            //This is completely different input than cartisian acc given in beta and alpha!!!
